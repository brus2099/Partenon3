...
public class OperacionesRacionales {
	...
	public Racional suma() {
		...
		racionalTres.setNumerador((this.racionalUno.getNumerador() * this.racionalDos.getDenominador())
	...
	public Racional suma(Racional racionalUno, Racional racionalDos) {
		Racional racionalTres = new Racional();
		racionalTres.setDenominador(racionalUno.getDenominador() * racionalDos.getDenominador());
		racionalTres.setNumerador((racionalUno.getNumerador() * racionalDos.getDenominador())
	...
	public Racional multiplicacion() {
		Racional racionalTres = new Racional();
		racionalTres.setDenominador(this.racionalUno.getDenominador() * this.racionalDos.getDenominador());
		racionalTres.setNumerador(this.racionalUno.getNumerador() * this.racionalDos.getNumerador());
		return racionalTres;
	}
